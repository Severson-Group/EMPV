 ...
 */
 ...
 #define KISSFFT_ERROR 1
 #define KISSFFT_WARNING 2
 #define KISSFFT_INFO 3
 #define KISSFFT_DEBUG 4
 ...
 #define KISS_FFT_ERROR(...) KISS_FFT_LOG_MSG(KISSFFT_ERROR, __VA_ARGS__)
 #define KISS_FFT_WARNING(...) KISS_FFT_LOG_MSG(KISSFFT_WARNING, __VA_ARGS__)
 #define KISS_FFT_INFO(...) KISS_FFT_LOG_MSG(KISSFFT_INFO, __VA_ARGS__)
 #define KISS_FFT_DEBUG(...) KISS_FFT_LOG_MSG(KISSFFT_DEBUG, __VA_ARGS__)
