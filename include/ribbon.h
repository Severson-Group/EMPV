...
int ribbonInit(GLFWwindow* window, const char *filename) { // read from config file
    ...
    if (configFile == NULL) {
        printf("Error: file %s not found, generating default config file\n", filename);
        FILE *createFile = fopen(filename, "w");
        char defaultFile[] = {
            0x46, 0x69, 0x6c, 0x65, 0x2c, 0x20, 0x4e, 0x65, 0x77, 0x20, 0x4f, 0x73, 0x63, 0x69, 0x6c, 0x6c, 
            0x6f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x2c, 0x20, 0x4e, 0x65, 0x77, 0x20, 0x4f, 0x72, 0x62, 0x69, 
            0x74, 0x2c, 0x20, 0x53, 0x61, 0x76, 0x65, 0x2c, 0x20, 0x4f, 0x70, 0x65, 0x6e, 0x0a, 0x45, 0x64, 
            0x69, 0x74, 0x2c, 0x20, 0x55, 0x6e, 0x64, 0x6f, 0x2c, 0x20, 0x52, 0x65, 0x64, 0x6f, 0x2c, 0x20, 
            0x43, 0x75, 0x74, 0x2c, 0x20, 0x43, 0x6f, 0x70, 0x79, 0x2c, 0x20, 0x50, 0x61, 0x73, 0x74, 0x65, 
            0x0a, 0x56, 0x69, 0x65, 0x77, 0x2c, 0x20, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x20, 0x54, 0x68, 
            0x65, 0x6d, 0x65, 0x2c, 0x20, 0x47, 0x4c, 0x46, 0x57
        };
        fwrite(defaultFile, sizeof(defaultFile), 1, createFile);
        fclose(createFile);
